...
const projects = [
  {
    ...
    imageId: "fixmyarea",
    live: "https://fixmy-area.vercel.app/",
    github: "https://github.com/CwPranay/fixmyarea",
  },
  {
    title: "AgroInsight",
    ...
    imageId: "agroinsight",
    live: "https://agro-insights.vercel.app/",
    github: "https://github.com/CwPranay/agroinsight",
  },
  {
    title: "OpenDesk",
    ...
    imageId: "opendesk",
    live: "https://opendesk-com.vercel.app/",
    github: "https://github.com/CwPranay/OpenDesk",
  },
  {
    title: "AplyO",
    ...
    <section id="projects" className="space-y-16 scroll-mt-20">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6 md:gap-10">
        {projects.map((project, i) => {
          ...
          const imageSrc = imageData?.imageUrl || `https://picsum.photos/seed/${project.imageId}/800/600`;
              ...
              >
                <div className="aspect-[4/3] relative overflow-hidden bg-zinc-900">
                  <Image
                    ...
                    data-ai-hint={imageData?.imageHint || "project screenshot"}
                  />
